 ...
 * Они приводят строки и массивы к нужному виду, собирают данные автора для ответа,
 * читают публичный номер рецепта из URL и создают типовые ошибки.
 * Эти функции ничего не ищут и не сохраняют в базе данных.
 * Принимает: отдельные значения, например строку `' Dinner '` или номер из URL `'42'`.
 * Возвращает: нормализованное значение, готовые данные автора или объект ошибки.
 * Пример: `normalizeSlug(' Dinner ')` возвращает `'dinner'`.
 */
